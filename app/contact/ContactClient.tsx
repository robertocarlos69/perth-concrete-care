        ...
        <div className="lg:col-span-2 rounded-3xl border bg-white p-7">
          ...
          <form className="mt-6 grid md:grid-cols-2 gap-4" onSubmit={handleSubmit} encType="multipart/form-data">
            ...
            <button
              ...
              className="md:col-span-2 rounded-xl bg-emerald-600 px-5 py-3 font-semibold text-white hover:bg-emerald-700 shadow-sm transition-colors disabled:opacity-60"
            >
