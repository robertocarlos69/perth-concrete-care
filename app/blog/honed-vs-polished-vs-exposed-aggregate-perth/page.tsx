...
const faqs = [
  {
    ...
    a: "Not when it's finished correctly. Honed concrete is the finish we recommend for outdoor and wet areas precisely because it can be sealed to a slip rating of P3 to P5, depending on the sealer and any added anti-slip grip. The slippery one is a high-gloss polished floor, which is why we keep that finish indoors.",
  },
  {
    ...
    <main className="min-h-screen bg-stone-100">
      ...
      <article className="mx-auto max-w-3xl px-4 pt-14 pb-16">
        ...
        <p className={`${p} mt-8 text-lg`}>
          ...
          not the same thing, and choosing the wrong one for the spot you have in
          mind is one of the more expensive mistakes we get called out to fix.
        </p>
        <p className={p}>
        ...
        <p className={p}>
          ...
          cured slab with progressively finer diamond tooling, stepping up through
          the grits, to cut back the top surface and expose the sand and stone
          within the concrete, then seal it. How much stone shows comes down to
          how deep we grind: a light{" "}
        ...
        <p className={p}>
          ...
          <strong>outdoors</strong>. We finish it to a slip rating (commonly P3 to
          P5 depending on the sealer and any added grip) so it stays safe around
          water, and we use UV-stable sealers so it doesn’t yellow or break down
          in the local sun. It’s ideal for pool surrounds, alfrescos, patios,
          courtyards, paths and outdoor entertaining areas.
        </p>
        <p className={p}>
        ...
        <p className={p}>
          ...
          keep going. We work through fine resin-bond diamond pads, often up to the
          1500 to 3000 grit range, usually with a lithium densifier to harden the
          surface and a guard to protect it, until the floor takes on a sheen. You
          can dial the gloss anywhere from a soft satin to a near-mirror finish.
        </p>
        <p className={p}>
          It suits living rooms, kitchens, hallways, retail floors, showrooms and
          warehouses. It works anywhere indoors that wants a hard-wearing,
          low-maintenance floor that reflects light and opens the space up. It’s
          extremely durable (it’s essentially a hardened version of the slab you
          already own), there’s no grout or carpet to stain, and it wipes clean.
        </p>
        <p className={p}>
          The honest trade-off is slip: a high-gloss polish can get slippery when
          wet, so it’s not what we recommend right around a pool. Properly finished
          with the right guard, indoor polished concrete can still meet slip
          requirements, but outdoors, hone-and-seal is the safer call. More detail
          on our{" "}
        ...
        <p className={p}>
          Yes, and it’s one of our most-requested jobs around Perth. If you’ve got
          a rough exposed-aggregate patio, pool surround or driveway that’s hard on
          bare feet, we can grind back the high points of the stone to leave a
          smoother, flatter, more refined surface while keeping the decorative
          aggregate look. You get most of the comfort and cleanability of a fresh
          honed slab without the cost of ripping out and re-pouring.
        </p>
        <p className={p}>
          ...
          We assess the existing slab first. If it’s sound, honing and resealing is
          usually far cheaper than replacement.
        </p>
        ...
        <p className={p}>
          ...
          importantly it can be sealed to a high slip rating so it stays safe when
        ...
        <p className={p}>
          ...
          premium finish that’s easier to keep clean. Both are valid. It comes down
          to budget and the look you’re after.
        </p>
          ...
          <table className="w-full min-w-[480px] text-sm border-collapse">
            ...
            <tbody className="text-stone-700">
              ...
              <tr className="border-b border-stone-100">
                ...
                <td className="px-4 py-3 whitespace-nowrap">from $60 to $80/m²</td>
              ...
              <tr>
                ...
                <td className="px-4 py-3 whitespace-nowrap">$140 to $220/m²</td>
        ...
        <ul className={ul}>
          <li><strong>Honed concrete</strong> for pool surrounds, outdoor entertaining and any barefoot area where you want a premium, low-maintenance, slip-rated finish.</li>
          <li><strong>Polished concrete</strong> for indoor living areas and commercial floors that want a durable, light-reflecting surface.</li>
          <li><strong>Exposed aggregate</strong> for driveways and budget-friendly decorative concrete where maximum grip matters.</li>
        </ul>
        <p className={p}>
        ...
        <div className="mt-12 rounded-3xl border border-emerald-200 bg-gradient-to-br from-emerald-50 via-white to-white p-6 md:p-8 shadow-sm">
          ...
          <p className="mt-2 text-stone-700 leading-relaxed">
            ...
            recommend the right finish. It’s a free, no-obligation assessment from
