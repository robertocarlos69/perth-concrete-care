      ...
      <section id="services" className="relative w-full py-24 overflow-hidden -mt-10 md:-mt-13">
        ...
        <div className="relative max-w-7xl mx-auto px-4 -mt-10 md:-mt-16">
          ...
          <p className="mt-2 text-neutral-700">
            End-to-end concrete preparation and finishes across Perth. Our floor preparation is all done to Australian
            Specifications (e.g., AS-1884, AS-3730, AS-3610, CSP/ICRI profiles) to ensure the right level of grinding
            before coatings and sealers are applied.
          </p>
          <p className="mt-2 text-sm text-neutral-700">
            We regularly service Joondalup, Wanneroo, Wangara, Malaga, Rockingham, Two Rocks and surrounding suburbs.
          </p>
      ...
      <section id="pricing" className="relative w-full bg-white/60 pt-4 pb-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="mt-2 text-neutral-600">
            Every slab is different; these ballparks help planning. Get a free on-site quote.
          </p>
          ...
          <p className="mt-4 text-sm text-neutral-600 leading-relaxed">
            *Pricing varies with slab hardness, m², access, repairs, and moisture. All prices incl. GST estimates.
          </p>

          <p className="mt-4 text-sm text-neutral-600 leading-relaxed">
            Achieving a long-lasting epoxy floor begins with correct surface preparation.
            All our floors are mechanically diamond-ground to a verified CSP2–CSP3 profile
            to ensure proper adhesion and prevent peeling or delamination.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="mt-3 text-sm text-neutral-400">
              Concrete grinding, honing, polishing, epoxy floors, and surface prep across Perth Metro. Indoor &amp;
              outdoor.
            </p>
...
function HeadTags() {
  ...
  return (
    <>
      ...
      <meta property="og:image" content="https://perthconcretecare.com.au/og-image.jpg" />
    ...
    <section className="bg-white/60">
      <div className="max-w-7xl mx-auto px-4 pt-4 pb-4">
        <h2 className="text-2xl md:text-3xl font-bold mb-4">
          Before &amp; After from our most recent project: Paint removal with a hone &amp; seal
        </h2>
        ...
        <p className="mt-4 text-sm text-neutral-600 max-w-3xl">
          This garage had old paint, tyre marks and uneven patches. We mechanically ground the slab, removed all
          coatings and installed a hone &amp; seal finish for a cleaner, brighter, easier-to-maintain floor with
          improved traction.
        </p>
      </div>
    </section>
...
const services = [
  {
    ...
    bullets: ['Premium exposed or washed aggregate options', 'Slip-resistant, hard-wearing outdoor surface', 'Ideal for driveways, paths, patios & pool surrounds'],
  },
  {
...
const pricing = [
  {
    ...
    price: '$45–$70',
    unit: '/m²',
    features: ['Light–medium grind (CSP-2/3)', 'One-coat or two-coat clear sealer', 'Edges & corners included'],
  },
  {
  ...
  },
  {
    ...
    price: '$110–$160',
    unit: '/m²',
    features: ['Premium washed or exposed stone finish', 'Slip-resistant and ideal for outdoor areas', 'Driveways, paths, alfresco & pool surrounds'],
  },
]
...
function runSelfTests() {
  ...
  if (failed.length) {
    ...
    console.info('[PCC self-tests] All tests passed:', tests.map((t) => t.name))
  }
}
// End of index.tsx
